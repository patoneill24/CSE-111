def main():
    ...
    if vin in vehicles_dict:
        ...
        manufacturer_value = value[MANUFACTURER_INDEX]
        model_value = value[MODEL_INDEX]
        color_value = value[COLOR_INDEX]      

        # Print the manufacturer, model, and color of the vehicle.
        # Don't print the year, engine design, or displacement.
        print(f'{manufacturer_value} {model_value} {color_value}')
