...
def main():
    ...
    # call the get_fomula_name to print the name of the formula based on the fomula the user enters
    periodic_table = make_periodic_table()
    for record in periodic_table.values():
        element_name = record[SYMBOL_INDEX]
        atomic_mass = record[ELEMENT_INDEX]
        print(f'{element_name} {atomic_mass}')
    formula = input('enter a chemical formula: ')
    checmical_sample_mass = float(input('enter the mass in the checmial sample in grams: '))
    ...
    number_of_moles = checmical_sample_mass/molar_mass
    print(molar_mass)
...
def compute_molar_mass(symbol_quantity_list, periodic_table_dict):
    ...
    for inner_list in symbol_quantity_list:
        ...
        element_name = periodic_table_dict[symbol]
        atomic_mass = element_name[ATOMIC_MASS_INDEX]
...
def sum_protons(symbol_quantity_list, periodic_table_dict):
    ...
    for key in periodic_table_dict:
        for inner_list in symbol_quantity_list:
            symbol = inner_list[SYMBOL_INDEX]
        periodic_table_dict[key].append(symbol)
